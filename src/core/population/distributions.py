...
class PopulationDistributions:
    ...
    def __init__(self, config_path: Optional[Path] = None):
        ...
        if config_path is None:
            ...
            config_path = Path(__file__).parent.parent.parent.parent / "data" / "reference" / "population_params.json"
    ...
    def get_sex_specific_distribution(self, category: str, param: str, sex: str) -> DistributionSpec:
        """
    ...
    def get_genotype_specific_distribution(
        self,
        param: str,
        genotype: str
    ) -> DistributionSpec:
    ...
    def get_activity_insulin_multipliers(self) -> Dict[str, float]:
        ...
        return self._config.get("lifestyle", {}).get("activity_level", {}).get(
