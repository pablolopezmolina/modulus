...
class VirtualPerson:
    ...
    def caffeine_tolerance_factor(self) -> float:
        ...
        max_reduction = 0.40
        reduction = min((self.habitual_caffeine_mg / 100.0) * reduction_per_100mg, max_reduction)
...
def create_test_person(
    preset: Literal[
        "young_athlete", "elderly_sedentary", "caffeine_sensitive", "insulin_resistant"
    ] = "young_athlete",
) -> VirtualPerson:
    """
